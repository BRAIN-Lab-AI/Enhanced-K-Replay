...
class OFAEncoder(OFAPreTrainedModel):
    ...
    def __init__(self, config: OFAConfig, embed_tokens: Optional[nn.Embedding] = None, use_patch_self_attn=False):
...
class OFAModel(OFAPreTrainedModel):
    ...
    def __init__(self, config: OFAConfig, use_patch_self_attn=False, **kwargs):
        super().__init__(config)
        self.use_patch_self_attn = use_patch_self_attn
        ...
        self.encoder = OFAEncoder(config, shared,  use_patch_self_attn=self.use_patch_self_attn)
